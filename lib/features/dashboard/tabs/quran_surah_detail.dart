...
class _SurahDetailScreenState extends State<SurahDetailScreen> {
  ...
  Future<void> _playAyah() async {
    try {
      final url = QuranService.getRecitationUrl(
          widget.surah.number, widget.reciterId);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('⚠️ تعذر تشغيل التلاوة، تأكد من الاتصال بالإنترنت')),
      );
    }
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _ayahs.isNotEmpty ? _playAyah : null,
          ),
        ],
      ),
      body: _isLoading
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            const Color(0xFF1C2541).withValues(alpha: 0.5),
